<div class="header">
  <div class="container">
    <a class="site-logo" href="/"><img src="/build/front/img/logos/logo-shop-red.png" alt="Metronic Shop UI"></a>
              ...
              <div class="header-navigation-content">
                <div class="row">
                  ...
                  <div class="col-md-12 nav-brands">
                    <ul>
                      <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="/build/front/img/brands/esprit.jpg"></a></li>
                      <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="/build/front/img/brands/gap.jpg"></a></li>
                      <li><a href="shop-product-list.html"><img title="next" alt="next" src="/build/front/img/brands/next.jpg"></a></li>
                      <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="/build/front/img/brands/puma.jpg"></a></li>
                      <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="/build/front/img/brands/zara.jpg"></a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="header-navigation-content">
                <div class="row">
                  <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="product-item">
                      <div class="pi-img-wrapper">
                        <a href="shop-item.html"><img src="/build/front/img/products/model4.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                      </div>
                  ...
                  <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="product-item">
                      <div class="pi-img-wrapper">
                        <a href="shop-item.html"><img src="/build/front/img/products/model3.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                      </div>
                      <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                      <div class="pi-price">$29.00</div>
                      <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
                  ...
                  <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="product-item">
                      <div class="pi-img-wrapper">
                        <a href="shop-item.html"><img src="/build/front/img/products/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                      </div>
                      <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                      <div class="pi-price">$29.00</div>
                      <a href="javascript:;" class="btn btn-default add2cart">Add to cart</a>
